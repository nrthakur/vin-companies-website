    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Company Cards - Simplified */}
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto mb-20">
            {/* Vin Engineering */}
            <Link href="/engineering" className="group">
              <Card className="h-full bg-gray-50 hover:bg-white border-0 hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8">
                  <div className="text-center space-y-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-[#233966] mb-3">
              ...
              <Card className="h-full bg-gray-50 hover:bg-white border-0 hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8">
                  <div className="text-center space-y-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-[#4B1A12] mb-3">
